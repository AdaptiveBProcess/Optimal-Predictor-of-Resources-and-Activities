...
class ProcessingTimePolicy(ABC):
    """
    An abstract base class for processing time policies.
    A processing time policy determines the duration of an activity, often referred to
    ...
    @abstractmethod
    def get_activity_duration(self, activity: "Activity", resource: "Resource") -> float:
        """
